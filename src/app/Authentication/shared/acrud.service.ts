...
export class ACrudService {
  ...
  ProfieData: { id: string; uname: string; desc: string; email: string; name: string; created_date?: Date; imgurl: Observable<string>; isProfileSet: boolean; category?: string };
  editedProfileData: { id: string; uname: string; desc: string; email: string; name: string; imgurl: Observable<string>; created_date?: Date; isProfileSet: boolean; category?: string };
  uname: any;
  id: any;
  ...
  createProfile(value: Profile) {
    ...
    this.getUid().then(d => {
      ...
      this.http.post(
        `https://angular-blogging-app-c3d71.firebaseio.com/post/${this.uid}/profile.json`,
        this.ProfieData
      )
  ...
  createPublicProfile(postdata: any, uname) {
    ...
    this.http.post(
      `https://angular-blogging-app-c3d71.firebaseio.com/PublicProfile/${uname}.json`,
      postdata
    )
  ...
  getProfile(): Observable<Profile[]> {
    ...
    if (this.uid) {
      ...
      return this.http.get<Profile[]>(`https://angular-blogging-app-c3d71.firebaseio.com/post/${this.uid}/profile.json`)
    }
    else {
  ...
  createPost(value: UPost) {
    ...
    if (value.privacy == "true") {
      this.getUid().then((d: any) => {
        this.uid = d
        this.http.post(
          `https://angular-blogging-app-c3d71.firebaseio.com/post/${this.uid}/public.json`,
          this.postdata
        )
          .subscribe(responseData => {
      ...
      this.http.post(
        `https://angular-blogging-app-c3d71.firebaseio.com/post/${this.uid}/private.json`,
        this.postdata
      )
        .subscribe(responseData => {
  ...
  getPublicPost(): Observable<UPost[]> {
    return this.http.get<UPost[]>(`https://angular-blogging-app-c3d71.firebaseio.com/post/${this.uid}/public.json`)

  }

  getPrivatePost(): Observable<UPost[]> {
    return this.http.get<UPost[]>(`https://angular-blogging-app-c3d71.firebaseio.com/post/${this.uid}/private.json`)

  }

  getAllData() {
    this.getUid()
    let x = this.http.get<UPost[]>(`https://angular-blogging-app-c3d71.firebaseio.com/post/${this.uid}/public.json`)
    let y = this.http.get<UPost[]>(`https://angular-blogging-app-c3d71.firebaseio.com/post/${this.uid}/private.json`)
    return forkJoin(x, y)
  ...
  getDemo1() {
    this.http.get<UPost[]>(`https://angular-blogging-app-c3d71.firebaseio.com/post/${this.uid}/private.json`)
      .pipe(
        map(responseData => {
  ...
  getDemo2() {
    this.http.get<UPost[]>(`https://angular-blogging-app-c3d71.firebaseio.com/post/${this.uid}/public.json`)
      .pipe(
        map(responseData => {
          const postsArray: UPost[] = [];
          for (const key in responseData) {
  ...
  deletePublicPost(postdata: {}, c: Observable<void>) {
    c.subscribe(x => {
      this.http.delete(
        `https://angular-blogging-app-c3d71.firebaseio.com/post/${this.uid}/public/${this.db_key}.json`)
        .subscribe(d => {
  ...
  deletePrivatePost(postdata: {}, c: Observable<void>) {
    c.subscribe(x => {
      this.http.delete(
        `https://angular-blogging-app-c3d71.firebaseio.com/post/${this.uid}/private/${this.db_key}.json`)
        .subscribe(d => {
  ...
  Edit_Private_Post(postdata: {}, c) {
    c.subscribe(x => {
      this.http.patch(
        `https://angular-blogging-app-c3d71.firebaseio.com/post/${this.uid}/private/${this.db_key}.json`, postdata)
        .subscribe(d => {
  ...
  Edit_Public_Post(postdata: {}, c) {
    c.subscribe(x => {
      this.http.patch(
        `https://angular-blogging-app-c3d71.firebaseio.com/post/${this.uid}/public/${this.db_key}.json`, postdata)
        .subscribe(d => {
          this.router.navigate([`myposts/${this.url}/${this.post_id}`]);
          this.showSuccessEdit()
        })
  ...
  UpdateProfile(value, oldvalue, imgdownloadurl) {
    ...
    c.subscribe(d => {
      ...
      this.http.patch(
        `https://angular-blogging-app-c3d71.firebaseio.com/post/${this.uid}/profile/${this.db_key}.json`,
        this.editedProfileData
      )
        .subscribe(responseData => {
  ...
  getPublicProfileKey(value: any, uname: any) {
    ...
    return this.http.get<Profile[]>(`https://angular-blogging-app-c3d71.firebaseio.com/PublicProfile/${uname}.json`)
      .pipe(
        map(responseData => {
  ...
  getProfileFromUid(uid): Observable<UPost[]> {
    ...
    return this.http.get<UPost[]>(`https://angular-blogging-app-c3d71.firebaseio.com/post/${uid}/profile.json`)
  }
  ...
  CreateLikeEntry(likecount, likestatus, postuserid, title, desc) {
    ...
    x.subscribe(post => {
      ...
      this.http.patch(
        `https://angular-blogging-app-c3d71.firebaseio.com/post/${postuserid}/public/${postid}/likestatus.json`,
        likedata)
      ...
      this.PostDataForLikedByUser.subscribe(d => {
        ...
        if (found) {
          this.http.put(
            `https://angular-blogging-app-c3d71.firebaseio.com/post/${postuserid}/public/${postid}/likestatus/uid/${userlikedetailkey}.json`,
            userdata
          ).subscribe(d => {
        ...
        if (!found) {
          this.http.post(
            `https://angular-blogging-app-c3d71.firebaseio.com/post/${postuserid}/public/${postid}/likestatus/uid.json`,
            userdata
          ).subscribe(d => {
  ...
  getLike(postuserid, title, desc) {
    let dbkey
    this.http.get(
      `https://angular-blogging-app-c3d71.firebaseio.com/post/${postuserid}/public.json`)
      .subscribe(post => {
        for (const key in post) {
          if ((post[key].title == title) && (post[key].desc == desc)) {
            dbkey = key
        ...
        return this.http.get(
          `https://angular-blogging-app-c3d71.firebaseio.com/post/${postuserid}/public/${dbkey}/likestatus.json`)
      })
  }
  ...
  getPostDetailForLike(postid, title, desc) {
    ...
    x.subscribe(post => {
      ...
      if (dbkey) {
        this.http.get(`https://angular-blogging-app-c3d71.firebaseio.com/post/${postid}/public/${dbkey}.json`)
          .subscribe((data: any) => {
  ...
  CreateComment(value, currentUserId, post_userid, title, desc) {
    return new Promise(res => {
      ...
      this.getCommentKey(post_userid, title, desc).
        then(d => {
          dbkey = d
          this.http.post(`https://angular-blogging-app-c3d71.firebaseio.com/post/${post_userid}/public/${dbkey}/commentData.json`, this.commentData)
            .subscribe((data: any) => {
  ...
  getCommentDataFromKey(post_userid, dbkey) {
    return this.http.get(`https://angular-blogging-app-c3d71.firebaseio.com/post/${post_userid}/public/${dbkey}/commentData.json`)
  }
  ...
  getFeaturedPost() {
    return new Promise(resolve => {
      this.http.get(
        `https://angular-blogging-app-c3d71.firebaseio.com/post.json`).subscribe(d => {
          let x = this.seprate(d)
